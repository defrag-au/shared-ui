...
fn render_story(story: Story) {
    ...
    let content = match story {
        ...
        Story::FlowOverview => render_flow_overview_story(),
        Story::FlowState => render_flow_state_story(),
        Story::FlowOperations => render_flow_operations_story(),
...
fn render_attribute_card(name: &str, values: &str, description: &str) -> Element {
    let card = create_element("div", &["wallet-card"]);
...
fn render_memory_card_story() -> Element {
    ...
    card1.set_attribute("image-url", "https://img.pfp.city/4523c5e21566a32540ef9db711fc61ce903cee93b66d50b5be2a59e916a4c065/img/thumb/BlackFlagPirates0001.png").unwrap();
    card1.set_attribute("name", "Face Down").unwrap();
    grid.append_child(&card1).unwrap();

    // Flipped card
    let card2 = document().create_element("memory-card").unwrap();
    card2.set_attribute("image-url", "https://img.pfp.city/4523c5e21566a32540ef9db711fc61ce903cee93b66d50b5be2a59e916a4c065/img/thumb/BlackFlagPirates0042.png").unwrap();
    ...
    card3.set_attribute("image-url", "https://img.pfp.city/4523c5e21566a32540ef9db711fc61ce903cee93b66d50b5be2a59e916a4c065/img/thumb/BlackFlagPirates0123.png").unwrap();
    ...
    card4.set_attribute("image-url", "https://img.pfp.city/4523c5e21566a32540ef9db711fc61ce903cee93b66d50b5be2a59e916a4c065/img/thumb/BlackFlagPirates0256.png").unwrap();
    ...
    let demo_card: web_sys::HtmlElement = document()
        ...
        .unwrap()
        .unchecked_into();
    demo_card.set_attribute("image-url", "https://img.pfp.city/4523c5e21566a32540ef9db711fc61ce903cee93b66d50b5be2a59e916a4c065/img/thumb/BlackFlagPirates0512.png").unwrap();
    ...
    let attr1 = render_attribute_card(
        "image-url",
        "URL string",
        "URL of the asset image shown when flipped",
    );
    grid3.append(&attr1);
...
fn render_flow_overview_story() -> Element {
    let container = create_element("div", &[]);
...
fn render_flow_concept_card(title: &str, description: &str) -> Element {
    let card = create_element("div", &["wallet-card"]);
...
fn render_flow_state_story() -> Element {
    let container = create_element("div", &[]);
...
fn render_flow_operations_story() -> Element {
    let container = create_element("div", &[]);
